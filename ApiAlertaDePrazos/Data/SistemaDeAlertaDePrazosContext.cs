    ...
    public class SistemaDeAlertaDePrazosContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
           ...
           modelBuilder.Entity<Regra>().HasData(
                ...
                {
                    Id = 10,
                    Nome = "Limite mínimo de matrícula em disciplinas",
                    Descricao = "Verifica se o aluno está matriculado em 2 ou menos curriculares para notifica-lo de que ao realizar trancam.",
                    IsActive = true,
                    Parametros = "[1]"
                }
                );
